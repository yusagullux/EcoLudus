...
const SEED_STOPS = [
  ...
  { id: "stop_park_victoria",       name: "Victoria Park",               type: "park",             lat: 51.5390, lng: -0.0341, xpReward: 40, ecoReward: 22, cooldownHours: 24, description: "East London's largest park with nature zones and community events." },
  ...
  { id: "stop_trail_epping",        name: "Epping Forest Entry",         type: "nature_trail",     lat: 51.6677, lng:  0.0548, xpReward: 65, ecoReward: 40, cooldownHours: 48, description: "Ancient royal forest — one of the largest public open spaces near London." },
  ...
  { id: "stop_trail_vincennes",     name: "Bois de Vincennes Trail",     type: "nature_trail",     lat: 48.8316, lng:  2.4342, xpReward: 55, ecoReward: 32, cooldownHours: 24, description: "Marked nature trails through Paris's largest public woodland." },

  // ── Berlin, Germany ───────────────────────────────────────────────────────
  { id: "stop_park_tiergarten",     name: "Tiergarten Forest Walk",      type: "park",             lat: 52.5098, lng: 13.3573, xpReward: 45, ecoReward: 25, cooldownHours: 24, description: "Berlin's urban forest park — 210 hectares of trees and meadows." },
  ...
  { id: "stop_park_vondelpark",     name: "Vondelpark Green Loop",       type: "park",             lat: 52.3572, lng:  4.8641, xpReward: 42, ecoReward: 24, cooldownHours: 24, description: "Amsterdam's most-visited park — great for cycling and birdwatching." },
  ...
  { id: "stop_bike_amsterdam_c",    name: "Fietspunt Centraal",          type: "bike_station",     lat: 52.3789, lng:  4.9006, xpReward: 28, ecoReward: 16, cooldownHours: 8,  description: "Massive guarded bike parking and repair shop at Amsterdam Centraal." },
  ...
  { id: "stop_recycling_nyc_ues",   name: "Union Square Greenmarket Recycling", type: "recycling", lat: 40.7359, lng: -73.9911, xpReward: 38, ecoReward: 22, cooldownHours: 12, description: "Textile and electronics recycling drop-off at the Union Square Greenmarket." },
  ...
  // ── Los Angeles, USA ──────────────────────────────────────────────────────
  { id: "stop_park_griffith",       name: "Griffith Park Nature Walk",   type: "park",             lat: 34.1344, lng: -118.3051, xpReward: 48, ecoReward: 27, cooldownHours: 24, description: "One of the largest urban parks in the US with trails and native plants." },
  ...
  { id: "stop_trail_sg_bukit_timah","name": "Bukit Timah Nature Reserve", type: "nature_trail",    lat:  1.3541, lng: 103.7794, xpReward: 65, ecoReward: 38, cooldownHours: 24, description: "Primary rainforest reserve — highest biodiversity per square km on Earth." },
  ...
  { id: "stop_trail_sp_cantareira", name: "Parque Estadual da Cantareira", type: "nature_trail",   lat: -23.4019, lng: -46.6025, xpReward: 68, ecoReward: 40, cooldownHours: 48, description: "The world's largest urban forest — Atlantic Forest trails and waterfalls." },

  // ── Cape Town, South Africa ───────────────────────────────────────────────
  { id: "stop_park_ct_kirstenbosch","name": "Kirstenbosch Garden Walk",  type: "park",             lat: -33.9856, lng:  18.4301, xpReward: 50, ecoReward: 28, cooldownHours: 24, description: "World-famous botanical garden on the slopes of Table Mountain." },
  ...
  // ── Tallinn, Estonia ──────────────────────────────────────────────────────
  { id: "stop_park_tallinn_kadriorg",    name: "Kadriorg Park",                  type: "park",             lat: 59.4402, lng: 24.7950, xpReward: 45, ecoReward: 25, cooldownHours: 24, description: "Baroque park built by Peter the Great, with forested paths and a swan pond." },
  { id: "stop_park_tallinn_stroomi",     name: "Stroomi Beach Park",             type: "park",             lat: 59.4431, lng: 24.6841, xpReward: 40, ecoReward: 22, cooldownHours: 24, description: "Sandy beachside park on Tallinn Bay, popular for walks and picnics." },
  ...
  { id: "stop_park_tallinn_glehn",       name: "Glehni Park",                    type: "park",             lat: 59.3873, lng: 24.6533, xpReward: 42, ecoReward: 24, cooldownHours: 24, description: "Romantic Victorian-era park with a castle folly and ancient trees." },
  { id: "stop_park_tallinn_laululava",   name: "Song Festival Grounds Green",    type: "park",             lat: 59.4451, lng: 24.8061, xpReward: 38, ecoReward: 21, cooldownHours: 24, description: "Parkland around the iconic song festival amphitheatre overlooking the bay." },
  ...
  { id: "stop_trail_tallinn_pirita",     name: "Pirita Coastal Trail",           type: "nature_trail",     lat: 59.4782, lng: 24.8354, xpReward: 55, ecoReward: 32, cooldownHours: 24, description: "Scenic 5km trail along the Pirita river mouth and Baltic coast." },
  ...
  { id: "stop_trail_tallinn_rocca",      name: "Rocca al Mare Shoreline Trail",  type: "nature_trail",     lat: 59.4349, lng: 24.6380, xpReward: 52, ecoReward: 30, cooldownHours: 24, description: "Coastal walking trail past the Open Air Museum with views of the Baltic." },
  ...
  { id: "stop_bike_tallinn_balti",       name: "Balti Jaam Cycle Point",         type: "bike_station",     lat: 59.4390, lng: 24.7339, xpReward: 30, ecoReward: 18, cooldownHours: 8,  description: "Bike parking and share station at Tallinn's main railway station." },
  ...
  { id: "stop_park_mumbai_sanjay",  name: "Sanjay Gandhi National Park", type: "park",             lat: 19.2150, lng:  72.9122, xpReward: 55, ecoReward: 32, cooldownHours: 24, description: "Tropical dry deciduous forest inside Mumbai — leopards, butterflies, and birds." },
